...
void test_initialize_memory_manager_valid_config(void) {
    memory_manager_config config = { .bucket_size = 10, .pre_allocation_factor = 0.5, .allocate_list_pool = true, .allocate_tree_pool = false };
...
void test_initialize_memory_manager_invalid_config(void) {
    memory_manager_config config1 = { .bucket_size = 0, .pre_allocation_factor = 0.5, .allocate_list_pool = true, .allocate_tree_pool = false };
    TEST_ASSERT_EQUAL(-1, initialize_memory_manager(config1));
    memory_manager_config config2 = { .bucket_size = 10, .pre_allocation_factor = 0.0, .allocate_list_pool = true, .allocate_tree_pool = false };
    TEST_ASSERT_EQUAL(-1, initialize_memory_manager(config2));
    memory_manager_config config3 = { .bucket_size = 10, .pre_allocation_factor = 1.5, .allocate_list_pool = true, .allocate_tree_pool = false };
    TEST_ASSERT_EQUAL(-1, initialize_memory_manager(config3));
}

void test_allocate_and_free_from_list_pool(void) {
    memory_manager_config config = { .bucket_size = 5, .pre_allocation_factor = 1.0, .allocate_list_pool = true, .allocate_tree_pool = false };
...
void test_allocate_and_free_from_tree_pool(void) {
    memory_manager_config config = { .bucket_size = 3, .pre_allocation_factor = 1.0, .allocate_list_pool = false, .allocate_tree_pool = true };
...
void test_free_invalid_pointer(void) {
    memory_manager_config config = { .bucket_size = 2, .pre_allocation_factor = 1.0, .allocate_list_pool = true, .allocate_tree_pool = false };
    TEST_ASSERT_EQUAL(0, initialize_memory_manager(config));
...
void test_initialize_memory_manager_both_pools(void) {
    memory_manager_config config = { .bucket_size = 4, .pre_allocation_factor = 1.0, .allocate_list_pool = true, .allocate_tree_pool = true };
    TEST_ASSERT_EQUAL(0, initialize_memory_manager(config));
