...
/**
 * @fn update_node_in_sub_hash_table
 ...
 * @brief Adds a new data node in the sub-hash-bucket by key and key hash.
 * @param args Structure containing sub-hash-bucket pointer, key, and key hash.
 * @param new_value New value to set in the node.
 ...
 * @brief Retrieves a data node's value from the sub-hash-bucket by key and key hash.
 * @param args Structure containing sub-hash-bucket pointer, key, and key hash.
 ...
 * @brief Soft deletes a data node from the sub-hash-bucket by key and key hash.
 * @param args Structure containing sub-hash-bucket pointer, key, and key hash.
